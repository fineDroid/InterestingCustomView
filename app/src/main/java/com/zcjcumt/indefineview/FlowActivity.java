...
public class FlowActivity extends Activity {
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		layoutParams1.leftMargin = CustomUtil.dip2px(this, 0);
		layoutParams1.rightMargin = CustomUtil.dip2px(this, 0);
		layoutParams1.topMargin = CustomUtil.dip2px(this, 0);
		layoutParams1.bottomMargin = CustomUtil.dip2px(this, 0);
